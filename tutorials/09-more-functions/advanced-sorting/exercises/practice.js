...
let optimizedPings = [...pingMetricsMs].sort((a, b) => a - b)
...
const highPriorityEngagements = [...targetLockProfiles].sort((a, b) => b.structuralBreachChance - a.structuralBreachChance)
